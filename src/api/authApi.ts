...
export const login = async (email: string, password: string): Promise<{token: string, username: string, id:string}> => {
    try {
...
export const register = async (name: string, email: string, password: string, phone: string): Promise<{token: string, username: string, id:string}> => {
    try {
