    ...
    return(
        <View className="flex w-full h-full pt-8">
            <Tab.Navigator initialRouteName="Test" screenOptions={{ tabBarStyle: {paddingBottom: 4},headerShown: false, tabBarActiveTintColor: "#14B8A6", tabBarInactiveTintColor: "#6B7280"}}>
                ...
                <Tab.Screen name="Test" component={Test} options={{tabBarLabel: "Teste", tabBarIcon: ({color}) => <Octicons name="pencil" size={24} color={color}/>}} />
                <Tab.Screen name="Profile" component={Profile} options={{tabBarLabel: "Perfil", tabBarIcon: ({color}) => <Ionicons name="person-outline" size={24} color={color}/>}}/>
            </Tab.Navigator>
        </View>
    )
}
