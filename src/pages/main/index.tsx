...
export const Main = () => {
    return(
        <View className="flex w-full h-full">
            <Tab.Navigator initialRouteName="Test" screenOptions={{headerShown: false, tabBarActiveTintColor: "#14B8A6", tabBarInactiveTintColor: "#6B7280"}}>
                ...
                <Tab.Screen name="Test" component={Test} options={{tabBarLabel: "Learn", tabBarIcon: ({color}) => <Foundation name="pencil" size={24} color={color}/>}} />
