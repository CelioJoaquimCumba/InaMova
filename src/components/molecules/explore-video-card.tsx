...
export const ExploreVideoCard = ({
  ...
  return (
    <View
      className={"flex flex-col p-4 bg-white mx-2 items-center rounded-lg border-b-2 border-gray-300"}
    >
      <Image source={image} className="w-32 aspect-[3/2] rounded-lg" />
      <View className="flex flex-row flex-grow self-stretch p-2 justify-between  items-center space-x-2">
        <Text className="text-base leading-6 font-bold gray-700">{title}</Text>
        {locked &&
